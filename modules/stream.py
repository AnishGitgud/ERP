...
#     # call methods from evaluation module
#     def get_grades(self):
#         """get grades for the stream"""
#         pass

#     def get_grade(self, course_name: str):
#         """get a grade for a course in the stream"""
#         pass

#     def set_grade(self, course_name: str, grade: str):
#         """set a grade for a course in the stream"""
#         pass


#     # call methods from history module
#     def get_history(self):
#         """get history for the stream"""
#         pass


#     # call methods from posts module
#     def get_posts(self):
#         """get posts for the stream"""
#         pass


#     # # call methods from description module
#     # def get_data(self, stream_name):
#     #     return desc.get_description(stream=stream_name)

#     # def set_data(self, stream_name, description: str):
#     #     """get description and stuff for the stream"""
#     #     desc.set_description(stream=stream_name, description=description)
#     #     return f"Description for {desc.set_description} set to {desc.get_description(stream=stream_name)}"


# def main():
#     stream = Stream("soyboy")
#     stream.add_course("Python 101")
#     courses = stream.get_courses()
#     print(f"Courses in {stream.stream_name}: {courses}")
